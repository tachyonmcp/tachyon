...
public enum ExtensionNegotiation {
     ...
     * not invoked. An extension with {@link ServerExtension#requiresMetaEnvelope()} additionally
     * rejects a declared call that omits {@code _meta.<extensionId>} as invalid params.
     */
    REQUIRED,
     ...
     * client did not declare it (the {@link ServerExtension#requiresMetaEnvelope()} check is skipped
     * too). Nothing is synthesized: the extension stays disabled on the request context,
