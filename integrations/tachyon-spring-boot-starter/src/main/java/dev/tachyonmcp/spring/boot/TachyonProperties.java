...
public record TachyonProperties(
     ...
     * @param allowedOrigins      Exact origins the DNS-rebinding guard admits and the CORS handler
     *                            grants. Unset grants any loopback origin, on any port.
     ...
     * @param allowNullOrigin     Whether CORS grants an Origin header of null. The DNS-rebinding
     *                            guard still rejects such requests.
